...
export function ProductionAreaWidget({ entity }: { entity: Entity }) {
    ...
    useEffect(() => {
        ...
        setBottomQuad({
            ...
            dimensions: {
                width: Math.abs(bottom[1][0] - bottom[0][0]) * scale,
                height: Math.abs(bottom[3][2] - bottom[0][2]) * scale,
            },
        });
        ...
        setBackQuad({
            quad: projectedBack,
            dimensions: {
                width: Math.abs(back[1][0] - back[0][0]) * scale,
                height: Math.abs(back[0][1] - back[3][1]) * scale,
            },
        });
